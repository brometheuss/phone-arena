...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2017 at 03:12 PM
...
INSERT INTO `pictures` (`IdPicture`, `IdGallery`, `Picture`) VALUES
(1, 1, 'imgs/thumb/note4T.jpg'),
(2, 2, 'imgs/thumb/iphone6sT.jpg');
...
INSERT INTO `survey` (`IdSurvey`, `LabelSpan`) VALUES
(1, 'I don''t like it :('),
(2, 'You need more practice, but you''re doing great so far.'),
(3, 'Its not bad, I actually like it.'),
(4, 'Its pretty good, but I think i can make a better one.'),
(5, 'Its awesome, absolutely loved it!');
...
--
ALTER TABLE `pictures`
  MODIFY `IdPicture` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
