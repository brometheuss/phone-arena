...
INSERT INTO `survey` (`IdSurvey`, `LabelSpan`, `IdQuestion`, `Counter`) VALUES
(1, 'I don''t like it :(', 1, 89489),
(2, 'You need more practice, but you''re doing great so far.', 1, 88491),
(3, 'Its not bad, I actually like it.', 1, 91293),
(4, 'Its pretty good, but I think i can make a better one.', 1, 88645),
(5, 'Its awesome, absolutely loved it!', 1, 88197);
...
(4, 'Lule', 'Lazarevic', 'lule.masin@gmail.com', 'Lule290', '370a11a674d0e2489eda6cb101c55ef1', 794876400, 1, 'Male', 'avatars/1489508120ImGoingToSucceed.jpg', 2),
(5, 'Djole', 'Mitrovic', 'djole.masin@gmail.com', 'Djola28', '12e4ab372d691ef8dd83060fac440a58', 794876400, 1, 'Male', 'avatars/1489509748MonkeyDLuffy2.jpg', 2);
...
--
ALTER TABLE `users`
  MODIFY `IdUser` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
